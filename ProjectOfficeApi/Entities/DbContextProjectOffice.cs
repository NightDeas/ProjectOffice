...
public partial class DbContextProjectOffice : DbContext
{
    public DbContextProjectOffice()
    {
    }

    public DbContextProjectOffice(DbContextOptions<DbContextProjectOffice> options)
        : base(options)
    {
    }
