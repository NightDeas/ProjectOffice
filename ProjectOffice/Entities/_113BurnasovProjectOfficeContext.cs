...
public partial class _113BurnasovProjectOfficeContext : DbContext
{
    public _113BurnasovProjectOfficeContext()
    {
    }

    public _113BurnasovProjectOfficeContext(DbContextOptions<_113BurnasovProjectOfficeContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=169.254.131.3;Initial Catalog=113-Burnasov-ProjectOffice;User ID=Stud;Password=Qwerty123456$;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
